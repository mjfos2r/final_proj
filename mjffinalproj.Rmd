...
This is a tabbed document, each section will be tabbed to show the raw code in a single view and will also have a streamlined view that shows first by default. 


# intro tabs, datawranglin and tidyverse {.tabset}
...
#I like pipes. I like unix. I wish the pipe wasn't such a stupid remap like %>%
```
...
setwd("C:/Users/Michael/Desktop/final_proj_bisc450cv84")
#setwd("C:/Users/Michael/Desktop/final_proj_bisc450cv84")
...
filenames <- list.files(path = "/home/studentdesktop/classroom/myfiles", pattern = ".*pathview.png")
